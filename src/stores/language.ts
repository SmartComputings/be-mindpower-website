...
const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    'nutrition.detail.title': 'Alimentación inteligente, diseñada para ti.',
    'nutrition.detail.subtitle': 'Tecnología que cuida lo que comes.',
    'nutrition.detail.feature1': 'Planes de alimentación personalizados',
    "nutrition.detail.feature2": "Seguimiento de calorías y macros",
    "nutrition.detail.feature3": "Recetas saludables y fáciles",
  ...
  en: {
    ...
    "communities.detail.title": "Your decisions, smarter.",
    "communities.detail.subtitle": "",
    "communities.detail.feature1": "Automatic financial assistant",
    "communities.detail.feature2": "Personalized savings and goals",
    "communities.detail.feature3": "Easy-to-understand reports",
    'features.streaming.title': 'Streaming',
