...
const translations: Record<Lang, Record<string, string>> = {
  ...
  ar: {
    ...
    'nav.contact': 'اتصل بنا',
    'nav.features': 'المميزات',
    'about.title': 'نحن نؤمن بحياة رقمية أبسط.',
    'about.subtitle': 'نبني نظامًا بيئيًا يربط الأشخاص والشركات والخدمات في تطبيق واحد.',
    'about.description': 'يتكون فريقنا من مبدعين ومطورين ومصممين يشتركون في نفس الرؤية: جعل كل رسالة أو معاملة مالية أو تفاعل أسهل وأكثر أمانًا.',
    'menu.open': 'فتح القائمة',
    'menu.close': 'إغلاق القائمة',
    'menu.selectLanguage': 'اختر اللغة',
    'lang.select': 'اللغة',
